  ...
  switch (contentType) {
    case 'blockSplit': {
      const imageUrl = fields.image?.fields?.file?.url
        ...
        : '';
      const isReverse =
        fields.imagePosition === 'right' || fields.imagePosition === true;
      const contentHtml = fields.content
        ? documentToHtmlString(fields.content, renderOptions)
        : '';
      return `
    ...
    case 'blockComparison': {
      const beforeUrl = fields.beforeImage?.fields?.file?.url
        ? `https:${fields.beforeImage.fields.file.url}`
        : '';
      const afterUrl = fields.afterImage?.fields?.file?.url
        ? `https:${fields.afterImage.fields.file.url}`
        : '';
      return `
 ...
 */
export function adaptAsset(asset: Asset | undefined | null): AdaptedImage {
  if (!asset || !asset.fields || !asset.fields.file) {
    // Return a placeholder for missing assets to avoid build crashes
    return {
      src: 'https://placehold.co/1200x800/222/fff?text=Imagen+en+Contentful',
      width: 1200,
      height: 800,
  ...
  if (typeof file === 'string') {
    return {
      src: 'https://placehold.co/1200x800/222/fff?text=Invalid+File',
      width: 1200,
      height: 800,
...
export function adaptAuthor(entry: Entry<any, undefined, string>): Author {
  ...
  return {
    ...
    avatar: adaptAsset(fields.avatar as Asset).src,
    bio: typeof fields.bio === 'string' ? fields.bio : '',
    social: {
      linkedin:
        typeof fields.linkedin === 'string' ? fields.linkedin : undefined,
      twitter: typeof fields.twitter === 'string' ? fields.twitter : undefined,
      instagram:
        typeof fields.instagram === 'string' ? fields.instagram : undefined,
    },
  };
}
...
export function adaptBlogPost(entry: Entry<any, undefined, string>): Post {
  ...
  if (
    ...
    typeof fields.featuredImage === 'object' &&
    'fields' in fields.featuredImage
  ) {
  ...
  return {
    ...
    updatedDate:
      typeof fields.updatedDate === 'string' ? fields.updatedDate : undefined,
    image: imageUrl,
    author: author!,
    ...
    seo: {
      ...
      description:
        typeof fields.seoDescription === 'string'
          ...
          : undefined,
      keywords: Array.isArray(fields.seoKeywords)
        ? fields.seoKeywords.filter((k): k is string => typeof k === 'string')
        : undefined,
    },
    cta:
      typeof fields.ctaId === 'string'
        ? globalCTAs[fields.ctaId as keyof typeof globalCTAs]
        : undefined,
    internal: {
 ...
 */
export function adaptProjectPhase(entry: Entry<any>): ProjectPhase | null {
 ...
 */
export function adaptKeyFeature(entry: Entry<any>): KeyFeature | null {
  if (!entry || !entry.fields) return null;
  const fields = entry.fields;
  return {
    title: typeof fields.title === 'string' ? fields.title : '',
 ...
 * Adapt Portfolio Case from Contentful
 */
export function adaptPortfolioCase(
  ...
  return {
    ...
    projectType: (typeof fields.projectType === 'string'
      ? fields.projectType
      : undefined) as any,
    ...
    featuredImage: {
      ...
      caption:
        typeof fields.featuredImageCaption === 'string'
          ? fields.featuredImageCaption
          : undefined,
    },
    ...
    services: (Array.isArray(fields.services)
      ? fields.services.filter((s): s is string => typeof s === 'string')
      : []) as string[],
    ...
    process: Array.isArray(fields.processList)
      ? fields.processList
          .map((p: any) => adaptProjectPhase(p as Entry<any>))
          .filter((p): p is ProjectPhase => p !== null)
      : undefined,

    keyFeatures: Array.isArray(fields.keyFeaturesList)
      ? fields.keyFeaturesList
          .map((k: any) => adaptKeyFeature(k as Entry<any>))
          .filter((k): k is KeyFeature => k !== null)
      : undefined,
...
export function adaptHeroSlide(
  ...
  return {
    ...
    image: adaptAsset(fields.image as Asset).src,
...
export function adaptService(entry: Entry<any, undefined, string>): Service {
  ...
  let categorySlug =
    typeof fields.category === 'string' ? fields.category : 'general';
  if (
    fields.categoryRef &&
    typeof fields.categoryRef === 'object' &&
    'fields' in fields.categoryRef
  ) {
  ...
  return {
    ...
    priceMeta:
      typeof fields.duration === 'string' ? fields.duration : undefined,
    deliverables,
 ...
 */
export function adaptTestimonial(
  entry: Entry<any, undefined, string>
): Testimonial {
  if (!entry || !entry.fields) {
