...
export const selectedCases = [
  {
    ...
    description:
      'Transformación de un sitio estático en una plataforma transaccional que automatizó matrículas y pagos.',
  ...
  },
  {
    ...
    description:
      'Ecosistema digital para psicología clínica. Desde la captación del paciente hasta el agendamiento sin fricción.',
  ...
  },
  {
    ...
    description:
      'Modernización de una marca icónica. Rediseño de etiquetas y estrategia digital para el mercado craft.',
    image: tubingerImg,
  ...
  },
  {
    ...
    description:
      'Diseño UX/UI para simplificar el factoring. Hicimos fácil y transparente un proceso financiero complejo.',
    image: flipeameImg,
    tags: ['Fintech', 'UX/UI'],
